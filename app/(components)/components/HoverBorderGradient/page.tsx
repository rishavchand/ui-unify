...
`}
        ...
        filename="HoverBorderGradient.tsx"
        cli={`npx shadcn@latest add https://ui.aceternity.com/registry/hover-border-gradient.json`}
...
`}
                    filename="Google-GeminiEffect.tsx"
                  />
                </div>
              </div>
              <div className="flex gap-2 mt-4 ">
