          ...
          <>
              ...
              <div>
                <div className="bg-gray-100 dark:bg-zinc-800 p-3 rounded-md overflow-x-auto mt-2">
                  <Snippet symbol={<FaTerminal />}>
                    <span>npm install react-day-picker date-fns</span>
                  </Snippet>
                </div>
              </div>
            </div>
            <div>
              <div className="flex gap-2 mt-4 ">
                ...
                <div>Add the Button component to your project.</div>
              </div>
              <div className="mt-2 mb-4">
                <p className="text-base">
                  The Calendar component uses the Button component. Make sure
                  you have it installed in your project.
                </p>
              </div>
              <div>
                <div className="flex gap-2 mt-4 ">
