  ...
  return (
    <Tabs defaultValue="cli" className="overflow-hidden h-full">
      <TabsList className="flex w-full justify-start border-b border-gray-300 dark:border-gray-700">
        ...
        <TabsTrigger
          value="manual"
          className="px-4 py-2 data-[state=active]:border-b-2 dark-[state=active]:border-b-blue-500 dark:data-[state=active]:border-b-blue-400 data-[state=active]:rounded-none flex items-center"
        >
      ...
      <div className="mt-8">
        <TabsContent className=" overflow-auto " value="cli">
          {tab1Content}
        </TabsContent>
